This is only a prototype of a Reverse-Shell, 
it was not created for attacks of any kind.
...
the sudo command in telnet, 
if you want to run Reverse-Shell as root 
type the first command with sudo at the beginning.
